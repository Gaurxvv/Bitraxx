...
const Threads = ({ color = [1, 1, 1], amplitude = 1, distance = 0, enableMouseInteraction = false, lineCount = 40, ...rest }: ThreadsProps) => {
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      program.uniforms.iResolution.value[2] = width / height;
    }
