  ...
  return (
    <section className="pt-8 pb-16 md:pb-24 bg-[#0c0c0c] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex justify-center gap-6 sm:gap-12 md:gap-20 opacity-80 hover:opacity-100 transition-opacity duration-1000">
          {[
            ...
            <div key={item.label} className="flex items-center">
              <Reveal delay={idx * 100} className="text-center group min-w-[60px] sm:min-w-0">
