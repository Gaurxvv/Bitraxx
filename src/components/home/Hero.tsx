        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            ...
            <motion.div 
              ...
              className="inline-flex items-center gap-3 mb-8 md:mb-10 px-5 py-2 rounded-none border border-primary/20 bg-primary/5 backdrop-blur-md transition-all duration-700"
            >
